...
std::string ArtworkForGameId()
{
  ...
  {
    static constexpr char cover_url[] = "https://art.gametdb.com/wii/coverfullHQ/US/RSBE01.png";
                           ...
                           const std::string& current_game, bool reset_timer)
{
  ...
  {
    discord_presence.largeImageKey = "https://art.gametdb.com/wii/coverfullHQ/US/RSBE01.png";
    discord_presence.largeImageText = "Better Brawl";
  }
  ...
  {
    discord_presence.details = "Better Brawl";
  }
  else
